        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
					...
					<?=($findUser > 0 ? "<b><font color='GREEN'>SUCCESS: STOPPED HOURBOOST FOR ACCOUNT '".$sUser."'!</font></b><br />" : "")?>
					<?=($findUserString != $sUser ? "<b><font color='RED'>ERROR: ACCOUNT NOT FOUND!</font></b><br />" : "")?>
                    <form method="POST">
                        <div class="input-group">
                            <input class="input--style-4" type="text" id="username" name="username" placeholder="Steam Username">
                        </div>
                        <div class="p-t-15">
